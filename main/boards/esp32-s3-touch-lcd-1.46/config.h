...
// ========== ELECTRON BOT FEATURES ==========
// Servo control pins for robot movement
#define Right_Pitch_Pin GPIO_NUM_37  // 右臂旋转
#define Right_Roll_Pin GPIO_NUM_36   // 右臂推杆  
#define Left_Pitch_Pin GPIO_NUM_35   // 左臂旋转
#define Left_Roll_Pin GPIO_NUM_1     // 左臂推杆
#define Body_Pin GPIO_NUM_3          // 身体旋转
#define Head_Pin GPIO_NUM_8          // 头部转动

// Power management (using available ADC pins)
#define POWER_CHARGE_DETECT_PIN GPIO_NUM_9    // 充电检测
#define POWER_ADC_UNIT ADC_UNIT_1
#define POWER_ADC_CHANNEL ADC_CHANNEL_8       // GPIO9对应ADC1_CH8

// Version info
#define ESP32_S3_TOUCH_LCD_1_46_VERSION "1.0.0"
