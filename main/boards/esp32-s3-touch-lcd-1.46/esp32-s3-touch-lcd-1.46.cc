...
#define TAG "esp32_s3_touch_lcd_1_46"

// 控制器初始化函数声明
void InitializeTouchLcdBotController(Otto* otto);

class TouchLcdBoard : public WifiBoard {
private:
    ...
    Otto otto_;
    static TouchLcdBoard* instance_;
    ...
    void InitializeSpd2010Display() {
        ...
        display_ = new TouchLcdEmojiDisplay(panel_io, panel,
    ...
    void InitializeButtons() {
        ...
        iot_button_register_cb(boot_btn, BUTTON_SINGLE_CLICK, nullptr, [](void* button_handle, void* usr_data) {
            auto self = static_cast<TouchLcdBoard*>(usr_data);
    ...
    void InitializeController() { 
        InitializeTouchLcdBotController(&otto_); 
    }
...
DECLARE_BOARD(TouchLcdBoard);

TouchLcdBoard* TouchLcdBoard::instance_ = nullptr;
